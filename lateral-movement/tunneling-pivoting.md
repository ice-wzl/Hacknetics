...
- [Pivoting](#pivoting)
  ...
  * [LOL Techniques](#lol-techniques)
    + [Port scanning in bash can be done:](#port-scanning-in-bash-can-be-done-)
  * [Proxychains and FoxyProxy](#proxychains-and-foxyproxy)
    + [Proxychains](#proxychains)
      - [Other things to note when scanning through proxychains:](#other-things-to-note-when-scanning-through-proxychains-)
      - [Examples](#examples)
    + [FoxyProxy](#foxyproxy)
  ...
  * [Chisel](#chisel)
    + [Chisel Reverse SOCKS Proxy:](#chisel-reverse-socks-proxy-)
    + [Forward SOCKS Proxy:](#forward-socks-proxy-)
      - [Proxychains Reminder:](#proxychains-reminder-)
